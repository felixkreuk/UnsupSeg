...
parser = argparse.ArgumentParser(
    description="Make TIMIT dataset ready for unsupervised segmentation."
)
parser.add_argument(
    "--inpath", type=str, required=True, help="the path to the base timit dir."
)
parser.add_argument(
    "--outpath",
    type=str,
    required=True,
    help="the path to save the new format of the data.",
)
